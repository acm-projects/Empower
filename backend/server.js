      ...
      try {
        ...
        while (transcriptionJobStatus === 'IN_PROGRESS') {
          ...
          if (transcriptionJobStatus === 'COMPLETED') {
            ...
            console.log(`Transcription job failed: ${TranscriptionJob.FailureReason}`);
            return;
          } 
        ...
        if (!transcriptionResultUri) {
          ...
          console.log(`Error retrieving transcription result.`);
          return;
        }
...
app.post("/polly", async (req, res) => {
  try {
    ...
    console.log("Polly job complete " + ++turns, "     ", res);
...
//~~~~~~~THE CODE BELOW IS JOSH'S BACKEND, BEEN WORKING WITH THUYANS, SO COPIED AND PASTED HER BACKEND~~~~~~~~~~~~~~~~ 
